...
if ($_SERVER["HTTP_HOST"] == "idsweb7" || $_SERVER["HTTP_HOST"] == "localhost" || trim($_SERVER['HTTP_HOST']) == "192.168.3.118") 
{   
    $baseUrl = $PROTOCOL.$_SERVER['HTTP_HOST'].'/soulfoodshonali/userfiles/';
}
else
{
    $baseUrl = $PROTOCOL.$_SERVER['HTTP_HOST'].'/userfiles/';
}
